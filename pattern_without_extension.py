...
def parse(key, value, depth):
    global BRANCH, BRANCH_COUNT, BRANCH_WITH_VALUE, ERROR, FIRST_NON_NULL_BRANCH_NODE, LAST_NON_NULL_BRANCH_NODE, LEAF, LEAF_EVEN, LEAF_ODD, BRANCH_DEPTH, LEAF_DEPTH
